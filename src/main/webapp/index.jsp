...
<head>
	...
	<!-- Favicon-->
	<link rel="icon" type="image/x-icon" href="assets/my_image.png" />
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">FullStack Developer</a>
			<button
				...
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1">
						<!-- <button type="submit" name="signin" id="signin"
									class="nav-link py-3 px-0 px-lg-3 rounded" value="LOGIN">Logout
						</button> --></li>
					<!-- <a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To My world</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - FullStack Developer</p>
		</div>
	</header>
	<!-- Portfolio Section-->
